...
There are **18 built-in plugins**, and many of them work without any API key at all.
...
- **A split-flap display** (like a Vestaboard) that's already set up and working
...
| **[Plugins Overview](/docs/plugins/overview)** | All 18 plugins and what they do |
