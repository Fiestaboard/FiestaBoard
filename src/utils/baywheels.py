...
_station_info_cache: dict | None = None
...
class BayWheelsSource:
    ...
    @staticmethod
    def _get_station_information() -> dict | None:
        """
    ...
    def _parse_station_status(self, station_data: dict) -> dict | None:
        """
    ...
    def fetch_station_status(self) -> dict[str, any] | None:
        """
    ...
    def get_best_station(self) -> dict[str, any] | None:
        """
