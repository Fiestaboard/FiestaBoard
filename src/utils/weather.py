...
class WeatherSource:
    ...
    def fetch_current_weather(self) -> dict[str, any] | None:
        """
    ...
    def _fetch_single_location(self, location: str, location_name: str) -> dict[str, any] | None:
        """
...
def get_weather_source() -> WeatherSource | None:
