...
class CarouselService:
    ...
    def __init__(self, storage: CarouselStorage | None = None):
    ...
    def get_carousel(self, carousel_id: str) -> Carousel | None:
    ...
    def update_carousel(self, carousel_id: str, data: CarouselUpdate) -> Carousel | None:
    ...
    def resolve_page_id(self, ref_id: str, now_unix: float | None = None) -> str | None:
    ...
    def seconds_until_next_page(self, ref_id: str, now_unix: float | None = None) -> int | None:
...
_carousel_service: CarouselService | None = None
