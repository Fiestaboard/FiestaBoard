  ...
  render: () => (
    <>
      ...
      <div className="space-y-2">
        <p className="text-sm text-muted-foreground mb-4">Click buttons to show toast notifications</p>
        <div className="flex flex-wrap gap-2">
          <Button onClick={() => toast.success("Changes saved successfully")}>Success Toast</Button>
          <Button onClick={() => toast.error("Failed to save changes")}>Error Toast</Button>
          <Button onClick={() => toast.info("This is an informational message")}>Info Toast</Button>
          <Button onClick={() => toast.warning("Please review your settings")}>Warning Toast</Button>
          <Button onClick={() => toast.loading("Saving changes...")}>Loading Toast</Button>
        </div>
      </div>
    </>
  ),
...
export const WithDescription: Story = {
  render: () => (
    <>
      <Toaster />
      <div className="space-y-2">
        <p className="text-sm text-muted-foreground mb-4">Toasts with descriptions</p>
        <div className="flex flex-wrap gap-2">
          <Button
            onClick={() =>
...
export const DurationControl: Story = {
  render: () => (
    <>
      <Toaster />
      <div className="space-y-2">
        <p className="text-sm text-muted-foreground mb-4">Control toast duration</p>
        <div className="flex flex-wrap gap-2">
          <Button onClick={() => toast.success("Quick toast", { duration: 1000 })}>1 Second</Button>
          <Button onClick={() => toast.success("Normal toast", { duration: 3000 })}>3 Seconds</Button>
          <Button onClick={() => toast.success("Long toast", { duration: 10000 })}>10 Seconds</Button>
